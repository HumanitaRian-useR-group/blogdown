...
The dissemination of microdata (i.e. survey data) allows to reduce duplication in data collection; to improve the reliability and relevance of data; to support research to promoting development of new tools for using data. Last but not least, it enhance the credibility of the organisation that collected the data. 
 
In the context of the [grand bargain commitment of joint needs assessment](https://humanitarian-user-group.github.io/post/first-meeting/), being able to share such survey data, and therefore to __anonymise__ it beforehand, is a key requirement for collective data interpretation. 
<!--MORE-->
...
This analysis demonstrate that the first need is actually frame joint and collective data interpretation through __research agreement and protocols__ rather than to assume that simple data sharing can the way forward. 
